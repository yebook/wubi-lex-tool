...
The three baseline guides now include the first compiled S0 examples from `wubilex-codec`. Keep `00-bootstrap-guidelines` active until the remaining S0 crates provide equivalent implementation evidence.
